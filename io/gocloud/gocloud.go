...
//
// Deprecated: use [blobfs.KeyExtractor], which does not link any cloud SDK.
type KeyExtractor = blobfs.KeyExtractor

// Deprecated: use [blobfs.ErrEmptyObjectKey], which does not link any cloud SDK.
var ErrEmptyObjectKey = blobfs.ErrEmptyObjectKey

// Deprecated: use [blobfs.ErrUnsupportedObjectAuthority], which does not link
// any cloud SDK.
var ErrUnsupportedObjectAuthority = blobfs.ErrUnsupportedObjectAuthority
